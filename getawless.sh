...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
	...
	echo "No awless binary available for OS '$OSTYPE'. You may want to use go to install awless with 'go get -u github.com/hbbio/awless'"
  exit
fi
...
DOWNLOAD_URL="https://github.com/hbbio/awless/releases/download/$LATEST_VERSION/$FILENAME"
