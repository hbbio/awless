...
func buildAndZip(osname, arch string) error {
	...
	buildInfo := fmt.Sprintf("-X github.com/hbbio/awless/config.buildDate=%s -X github.com/hbbio/awless/config.buildSha=%s -X github.com/hbbio/awless/config.buildOS=%s -X github.com/hbbio/awless/config.buildArch=%s -X github.com/hbbio/awless/config.BuildFor=%s",
